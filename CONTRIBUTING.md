...
Discussion around _http4s-munit_ happens in the [GitHub issues](https://github.com/alejandrohdezma/http4s-munit/issues) and [pull requests](https://github.com/alejandrohdezma/http4s-munit/pulls).

Feel free to open an issue if you notice a bug, have an idea for a feature, or have a question about
the code. Pull requests are also welcome.

People are expected to follow the [Code of Conduct](CODE_OF_CONDUCT.md) when discussing _http4s-munit_ on the Github page or other venues.
