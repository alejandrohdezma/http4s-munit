...
```sbt
libraryDependencies += "com.alejandrohdezma" %% "http4s-munit" % 0.0.0 % Test) // if using http4s 0.23.x

libraryDependencies += "com.alejandrohdezma" %% "http4s-munit" % 0.8.0 % Test) // if using http4s 0.22.x

libraryDependencies += "com.alejandrohdezma" %% "http4s-munit" % 0.7.0 % Test) // if using http4s 0.21.x
```
...
```sbt
libraryDependencies += "com.alejandrohdezma" %% "http4s-munit-testcontainers" % 0.0.0 % Test)
```
