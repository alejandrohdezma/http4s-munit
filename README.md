...
```sbt
libraryDependencies += "com.alejandrohdezma" %% "http4s-munit" % 0.9.0 % Test) // if using http4s 0.23.x
...
```sbt
libraryDependencies += "com.alejandrohdezma" %% "http4s-munit-testcontainers" % 0.9.0 % Test)
```
