...
lazy val documentation = project
  ...
  .settings(libraryDependencies += "com.dimafeng" %% "testcontainers-scala-munit" % "0.40.9")
...
lazy val `http4s-munit` = module
  ...
  .settings(libraryDependencies += "org.http4s" %% "http4s-client" % "0.23.14")
  .settings(libraryDependencies += "org.http4s" %% "http4s-dsl" % "0.23.14")
  .settings(libraryDependencies += "org.http4s" %% "http4s-ember-client" % "0.23.14" % Optional)
  ...
  .settings(libraryDependencies += "org.http4s" %% "http4s-ember-client" % "0.23.14" % Test)
  .settings(
