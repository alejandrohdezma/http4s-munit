...
lazy val `http4s-munit` = module
  ...
  .settings(libraryDependencies += "org.http4s" %% "http4s-client" % "0.22.5")
  .settings(libraryDependencies += "org.http4s" %% "http4s-dsl" % "0.22.5")
  ...
  .settings(libraryDependencies += "org.http4s" %% "http4s-circe" % "0.22.5" % Test)
  .settings(libraryDependencies += "org.http4s" %% "http4s-blaze-client" % "0.22.5" % Test)
