...
lazy val `http4s-munit` = module
  ...
  .settings(libraryDependencies += "org.scalameta" %% "munit" % "1.3.0")
  .settings(libraryDependencies += "org.http4s" %% "http4s-client" % "0.23.34")
  .settings(libraryDependencies += "org.http4s" %% "http4s-dsl" % "0.23.34")
  .settings(libraryDependencies += "org.http4s" %% "http4s-ember-client" % "0.23.34" % Optional)
  .settings(libraryDependencies += "org.typelevel" %% "munit-cats-effect" % "2.2.0")
  ...
  .settings(libraryDependencies += "org.http4s" %% "http4s-ember-client" % "0.23.34" % Test)
