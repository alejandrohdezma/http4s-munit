...
lazy val `http4s-munit` = module
  ...
  .settings(libraryDependencies += "org.http4s" %% "http4s-client" % "0.21.27")
  .settings(libraryDependencies += "org.http4s" %% "http4s-dsl" % "0.21.27")
  ...
  .settings(libraryDependencies += "org.http4s" %% "http4s-circe" % "0.21.27" % Test)
  .settings(libraryDependencies += "org.http4s" %% "http4s-blaze-client" % "0.21.27" % Test)
  .settings(libraryDependencies += "org.typelevel" %% "mouse" % "1.0.4" % Test)
  .settings(addCompilerPlugin("org.typelevel" % "kind-projector" % "0.13.1" cross CrossVersion.full))
