...
lazy val `http4s-munit` = module
  ...
  .settings(libraryDependencies += "org.http4s" %% "http4s-client" % "0.23.9")
  .settings(libraryDependencies += "org.http4s" %% "http4s-dsl" % "0.23.9")
  ...
  .settings(libraryDependencies += "org.http4s" %% "http4s-ember-client" % "0.23.9" % Test)
