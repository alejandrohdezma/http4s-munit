...
lazy val `http4s-munit` = module
  ...
  .settings(libraryDependencies += "org.http4s" %% "http4s-client" % "0.23.3")
  .settings(libraryDependencies += "org.http4s" %% "http4s-dsl" % "0.23.3")
  ...
  .settings(libraryDependencies += "org.http4s" %% "http4s-circe" % "0.23.3" % Test)
  .settings(libraryDependencies += "org.http4s" %% "http4s-blaze-client" % "0.23.3" % Test)
